...
function Viverna.CreateWindow(libName, logoId)
    ...
    --
    libName = libName or "Viverna"
    logoId = logoId or ""
    --

    LuxtLib.Name = "Viverna"..libName
    ...
    sideCover.BackgroundColor3 = Color3.fromRGB(0, 0, 0)
    ...
    hubLogo.BackgroundColor3 = Color3.fromRGB(138, 43, 226)
    ...
    hubName.TextColor3 = Color3.fromRGB(138, 43, 226)
    ...
    usename.Text = "by ExRizzve"
    usename.TextColor3 = Color3.fromRGB(100, 100, 100)
    ...
    function TabHandling:Tab(tabText, tabId)
        ...
        tabLogo.ImageColor3 = Color3.fromRGB(138, 43, 226)
        --
        ...
        function sectionHandling:Section(sectionText)
            ...
            sectionName.TextColor3 = Color3.fromRGB(138, 43, 226)
            ...
            sectionExpannd.ImageColor3 = Color3.fromRGB(138, 43, 226)
                    ...
                    checkBtn.MouseButton1Click:Connect(function()
                        if not togDe then
                                ...
                                on = not on
                                 callback(on) 
                                if on then
                                    checkBtn.Parent.toggleInfo.TextColor3 = Color3.fromRGB(138, 43, 226)
                                    checkBtn.ImageColor3 = Color3.fromRGB(138, 43, 226)
